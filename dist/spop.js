...
;(function() {
	...
	SmallPop.prototype.create = function(template) {
		...
		layout ='<div class="spop-close" data-spop="close" aria-label="Close">&times;</div>'+icon +'<div class="spop-body">'+template+'</div>';
		...
		if (this.opt.group && typeof this.opt.group === 'string') {this.pop.setAttribute('id', 'spop--' + this.opt.group);}
	...
	// Helpers
	function $(el, con) {return typeof el === 'string'? (con || document).getElementById(el) : el || null;}
